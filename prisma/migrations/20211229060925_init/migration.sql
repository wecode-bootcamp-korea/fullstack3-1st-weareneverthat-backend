...
-- AddForeignKey
ALTER TABLE `products` ADD CONSTRAINT `products_cateory_id_fkey` FOREIGN KEY (`cateory_id`) REFERENCES `categories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `product_details` ADD CONSTRAINT `product_details_product_size_id_fkey` FOREIGN KEY (`product_size_id`) REFERENCES `product_sizes`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
